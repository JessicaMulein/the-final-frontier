...
def main() -> None:
    ...
    manifest = {
        ...
        # Identity of the text this render narrates. Without it the manifest
        # records only a path, so a passing render looks current forever and a
        # resumed batch skips a chapter whose prose has since changed.
