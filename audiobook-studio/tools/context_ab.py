...
PREVIOUS_MANIFEST_RELATIVE = (
    "audiobook-studio/build/narration/chapter-001-tiffany-context-ab/manifest.json"
)
SEGMENTS = (
    {
        "segment_id": "0011",
...
def _paths() -> dict[str, Path]:
    ...
    root = workspace / "audiobook-studio/build/narration/chapter-001-tiffany-context-ab-retry-1"
    return {
        "workspace": workspace,
        "config": workspace / "audiobook-studio/config/audition.toml",
        "source_manifest": workspace / "audiobook-studio/build/narration/chapter-001-tiffany/manifest.json",
        "root": root,
