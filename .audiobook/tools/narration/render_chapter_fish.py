...
sys.path.insert(0, str(Path(__file__).resolve().parents[1] / "kokoro-local"))
...
def verify(audio: np.ndarray, rate: int, expected: str, model: str) -> dict:
    ...
    from validate_stt import normalized_tokens  # noqa: F401  (kept for parity)
    from render_chapter_qwen3 import assess_transcript
