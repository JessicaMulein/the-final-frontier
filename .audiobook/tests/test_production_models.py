...
def _effective_config() -> EffectiveTrackConfig:
    return EffectiveTrackConfig(
        ...
        output_path=".audiobook/dist/audiobook/the-final-frontier/003-chapter-003-tiffany.wav",
...
def _track_plan() -> FrozenTrackPlan:
    return FrozenTrackPlan(
        ...
        maximum_new_calls=2,
        legacy_candidates=(".audiobook/build/narration/chapter-003/manifest.json",),
...
def _attempt() -> AttemptResult:
    return AttemptResult(
        ...
        working_directory=".audiobook/build/production/the-final-frontier",
        ...
        console_path=".audiobook/build/production/attempt-001/render-console.log",
        ...
        ValidationEvidence(
            ...
            checks=(
                ValidationCheck(
                    ...
                    status=ValidationStatus.PASSED,
                    artifact_path=".audiobook/build/production/runtime/manifest.json",
