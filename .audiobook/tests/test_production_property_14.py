...
def _safe_attempt_result(
    ...
    return {
        ...
        "working_directory": ".audiobook/build/production/property-14-book",
        "argv": [
            "python",
            "-m",
        ...
        "console_path": (
            ".audiobook/build/production/property-14-book/transactions/"
...
def _exercise_confinement_and_immutable_history(
    ...
    evidence_root = workspace / ".audiobook" / "build" / "production" / "property-14-book"
    delivery_root = workspace / ".audiobook" / "dist" / "audiobook" / "property-14-book"
    transaction_root = (
        evidence_root
        / "transactions"
